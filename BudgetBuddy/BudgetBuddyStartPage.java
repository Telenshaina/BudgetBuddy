...
public class BudgetBuddyStartPage extends JFrame {
    ...
    public BudgetBuddyStartPage(){
        ...
        try {
            ImageIcon logo = new ImageIcon("C:\\Users\\John Keith Mercado\\OneDrive\\Desktop\\2-BSCS-1 (SECOND SEM)\\Design and Analysis of Algorithms\\INTRO.png");//change path to image path
